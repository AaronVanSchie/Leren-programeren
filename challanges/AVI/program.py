...
def calculate():
    ...
    wordsLabel.config(text=f"Words: {getNumberOfWords(textToBeCalculated)}")
...
wordsLabel = tk.Label(root, text=f'Words:', width=20, bg='black', fg='white')    # generate sentencesLabel
